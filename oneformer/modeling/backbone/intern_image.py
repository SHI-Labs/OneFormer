...
from oneformer.modeling.backbone.ops_dcnv3 import modules as opsm
    ...
    def forward(self, x):
        ...
        for level_idx, level in enumerate(self.levels):
            ...
            if level_idx in self.out_indices:
                outs["res{}".format(level_idx + 2)] = x_.permute(0, 3, 1, 2).contiguous()

        return outs

@BACKBONE_REGISTRY.register()
class D2InternImage(InternImage, Backbone):
    def __init__(self, cfg, input_shape):
        ...
        drop_path_rate = cfg.MODEL.INTERNIMAGE.DROP_RATE 
        ...
        out_indices = cfg.MODEL.INTERNIMAGE.OUT_INDICES 
        ...
        super().__init__(
            ...
            level2_post_norm=level2_post_norm,
            level2_post_norm_block_ids=level2_post_norm_block_ids,
            center_feature_scale=center_feature_scale,
            with_cp=with_cp,
            out_indices=out_indices,
        )

        self._out_features = cfg.MODEL.INTERNIMAGE.OUT_FEATURES
